  ...
  <div class="block h-4/5 w-full grow bg-slate-400 p-4 dark:bg-slate-600">
    <div class="flex h-9 items-center">
      ...
      <div class="flex grow px-4 py-0">
        <input type="text" v-model="settings.alias" class="grow bg-neutral-100 dark:bg-slate-500" />
      </div>
    </div>
    <div class="flex h-9 items-center">
      <div class="w-24 px-4 py-0">URL</div>
      <div class="flex grow px-4 py-0">
        <input type="text" v-model="settings.url" class="grow bg-neutral-100 dark:bg-slate-500" />
      </div>
    </div>
    <div class="flex h-9 items-center">
      <div class="w-24 px-4 py-0"></div>
      <div class="flex grow items-center px-4 py-0">
        <input type="checkbox" v-model="settings.isUse" class="mr-1 h-4 w-4" id="is-sub-enabled" />
