    ...
    >
        ...
        <div class="flex h-10 w-full items-center bg-slate-400 px-2 text-base dark:bg-slate-500">
            ...
            <DropdownMenu withDropdownCloser>
                ...
                <template #body>
                    <ul
                        class="bg-slate-300 p-2 text-neutral-700 dark:bg-slate-600 dark:text-neutral-300"
                    >
                        <li>
                            <button @click="newScript" dropdown-closer>{{ t('newScript') }}</button>
                        </li>
                        <li v-if="isEditingLocalFile">
                            <button @click="switchEditorMode" dropdown-closer>
                                {{ t('switchEditorMode') }}
                            </button>
                        </li>
                        <li>
                            <button @click="showFileBrowser('load')" dropdown-closer>
                                {{ t('loadFile') }}
                            </button>
                        </li>
                        <li>
                            <button @click="showFileBrowser('save')" dropdown-closer>
                                {{ t('saveAs') }}
                            </button>
                        </li>
                        <li>
                            <button @click="openAttacher" dropdown-closer>
                                {{ t('openAttacher') }}
                            </button>
                        </li>
                    </ul>
